    ...
    return Object.assign({}, acc1, variants.reduce(function (acc2, _ref3) {
      ...
      return Object.assign({}, acc2, Object.entries(configs).reduce(function (acc3, _ref4) {
        ...
        return Object.assign({}, acc3, {
          [displayName]: hslToString(Object.assign({}, colorToHsla(hsluvToHex([hue, saturation, lightness])), {
            alpha
          }))
        });
      }, {}));
  ...
  function TrapFocus() {
    ...
    _this.handleBlur = function (event) {
      ...
      if (focusTrapWrapper && !focusTrapWrapper.contains(relatedTarget) && (!relatedTarget || !closest(relatedTarget, '[data-polaris-overlay]'))) {
        ...
        var firstNode = findFirstFocusableNode(focusTrapWrapper);
        write(function () {
