...
function buildColors(theme, roleVariants) {
  var colors = Object.assign({
    ...
    primary: exports.UNSTABLE_Color.Primary,
    ...
    decorative: exports.UNSTABLE_Color.Decorative
    ...
    return Object.assign({}, acc1, variants.reduce(function (acc2, _ref3) {
      ...
      return Object.assign({}, acc2, Object.entries(configs).reduce(function (acc3, _ref4) {
        ...
        return Object.assign({}, acc3, {
          [displayName]: hslToString(Object.assign({}, colorToHsla(hsluv.hsluvToHex([hue, saturation, lightness])), {
            alpha
          }))
        });
      }, {}));
...
var Popover = function Popover(_a) {
  var _a$activatorWrapper = _a.activatorWrapper,
      ...
      rest = tslib_1.__rest(_a, ["activatorWrapper", "children", "onClose", "activator", "active", "fixed", "ariaHaspopup"]);
...
var DropZone = function DropZone(_ref) {
  ...
  var fileInputNode = React.useRef(null);
...
function (_React$PureComponent) {
  ...
  function TrapFocus() {
    ...
    _this.handleBlur = function (event) {
      ...
      if (focusTrapWrapper && !focusTrapWrapper.contains(relatedTarget) && (!relatedTarget || !dom.closest(relatedTarget, '[data-polaris-overlay]'))) {
        event.preventDefault();
        ...
        var firstNode = focus.findFirstFocusableNode(focusTrapWrapper);
        fastdom.write(function () {
          return focus.focusFirstFocusableNode(firstNode);
        });
      }
    };
...
var getUniqueID$2 = other.createUniqueIDFactory('TooltipContent');
var Tooltip =
/*#__PURE__*/
function (_React$PureComponent) {
...
exports.UNSTABLE_buildColors = buildColors;
exports.UNSTABLE_roleVariants = roleVariants;
