...
.Polaris-Button--primary{
  --p-button-color:var(--p-primary-action);
  --p-button-text:var(--p-text-on-primary);
  --p-button-color-hover:var(--p-primary-action-hovered);
  --p-button-color-active:var(--p-primary-action-pressed);
...
.Polaris-Badge{
  ...
  align-items:center;
  padding:0 0.8rem;
  background-color:var(--p-neutral-action-disabled, #dfe3e8);
...
.Polaris-TextStyle--variationCode{
  ...
  font-size:1.15em;
  box-shadow:inset 0 0 0 1px var(--p-border-subdued-on-surface, #dfe3e8); }
...
.Polaris-InlineError{
  display:flex;
  color:var(--p-critical-text, #bf0711);
  fill:var(--p-critical-icon, #bf0711); }
...
.Polaris-Breadcrumbs__Breadcrumb{
  ...
  .Polaris-Breadcrumbs__Breadcrumb:hover, .Polaris-Breadcrumbs__Breadcrumb:active{
    ...
    .Polaris-Breadcrumbs__Breadcrumb:hover .Polaris-Breadcrumbs__Icon svg, .Polaris-Breadcrumbs__Breadcrumb:active .Polaris-Breadcrumbs__Icon svg{
      fill:var(--p-icon-on-surface, #212b36); }
  .Polaris-Breadcrumbs__Breadcrumb:focus{
    outline:none; }
...
.Polaris-Breadcrumbs__Icon{
  ...
  .Polaris-Breadcrumbs__Icon svg{
    fill:var(--p-icon-subdued-on-surface, #637381); }
...
.Polaris-DropZone-FileUpload{
  padding:1.5rem;
  text-align:center; }
  .Polaris-DropZone-FileUpload.Polaris-DropZone-FileUpload--measuring{
    display:none; }
...
.Polaris-ExceptionList__Icon{
  ...
  .Polaris-ExceptionList--statusWarning .Polaris-ExceptionList__Icon svg{
    fill:var(--p-warning-icon, #8a6116); }
...
.Polaris-ExceptionList__Bullet{
  ...
  height:0.6rem;
  border-radius:100%;
  background-color:var(--p-icon-subdued-on-surface, #919eab); }
  .Polaris-ExceptionList--statusWarning .Polaris-ExceptionList__Bullet{
    background-color:var(--p-warning-icon, #8a6116); }
  .Polaris-ExceptionList--statusCritical .Polaris-ExceptionList__Bullet{
    background-color:var(--p-critical-icon, #bf0711); }
...
.Polaris-ExceptionList--statusWarning .Polaris-ExceptionList__Title{
  color:var(--p-warning-text, #8a6116); }
...
.Polaris-Frame-Toast{
  ...
  padding:0.8rem 1.6rem;
  border-radius:var(--p-border-radius-wide, 3px);
  background:var(--p-surface-foreground-inverse, rgba(0, 0, 0, 0.88));
  box-shadow:var(--p-override-none, 0 0 0 1px rgba(63, 63, 68, 0.05), 0 1px 3px 0 rgba(63, 63, 68, 0.15));
  color:var(--p-text-on-surface-inverse, white);
  margin-bottom:2rem; }
  @media (min-width: 40em){
    .Polaris-Frame-Toast{
      font-size:2rem;
...
.Polaris-Frame-Toast--error{
  background:var(--p-critical-action, rgba(191, 7, 17, 0.88));
  color:var(--p-text-on-surface-dark, white); }
  .Polaris-Frame-Toast--error .Polaris-Frame-Toast__CloseButton{
    fill:var(--p-text-on-surface-dark, white); }
...
.Polaris-Frame-Toast__CloseButton{
  ...
  -webkit-appearance:none;
     -moz-appearance:none;
          appearance:none;
  background:transparent;
  fill:var(--p-text-on-surface-inverse, white);
  cursor:pointer; }
...
.Polaris-Frame-Loading__Level{
  ...
  height:100%;
  transform-origin:0;
  background-color:var(--p-highlight-border, #47c1bf);
...
.Polaris-Navigation__Item{
  ...
  .Polaris-Navigation__Item:hover{
    ...
    background-color:var(--p-surface-hovered);
    color:var(--p-primary-action, #202e78);
    text-decoration:none; }
    .Polaris-Navigation__Item:hover .Polaris-Navigation__Icon svg{
      fill:var(--p-primary-action, #5c6ac4);
  ...
  .Polaris-Navigation__Item:active, .Polaris-Navigation__Item:active:hover{
    color:var(--p-primary-action-pressed, #202e78); }
    ...
    .Polaris-Navigation__Item:active .Polaris-Navigation__Icon svg, .Polaris-Navigation__Item:active:hover .Polaris-Navigation__Icon svg{
      fill:var(--p-primary-action-pressed, #5c6ac4);
      color:var(--p-override-transparent, white); }
...
.Polaris-Navigation__Item--selected{
  ...
  .Polaris-Navigation__Item--selected:hover{
    ...
    color:var(--p-primary-action-hovered, #202e78); }
...
.Polaris-Navigation__RollupToggle{
  ...
  .Polaris-Navigation__RollupToggle:hover{
    color:var(--p-primary-action, #5c6ac4); }
...
.Polaris-ResourceList-CheckableButton{
  ...
  text-align:left;
  background:transparent;
  border:var(--p-override-none, 0.1rem solid var(--p-border-on-surface, #c4cdd5));
  border-radius:var(--p-border-radius-base, 3px);
  width:100%;
  ...
  .Polaris-ResourceList-CheckableButton.Polaris-ResourceList-CheckableButton__CheckableButton--selected{
    color:var(--p-text-on-surface, #5c6ac4); }
    @media (min-width: 28.625em){
      .Polaris-ResourceList-CheckableButton.Polaris-ResourceList-CheckableButton__CheckableButton--selected{
        border-color:#c4cdd5; } }
...
.Polaris-MessageIndicator{
  ...
  height:1.2rem;
  border-radius:100%;
  background-color:var(--p-highlight-icon, #47c1bf);
  border:solid 0.2rem var(--p-surface-background, var(--top-bar-background)); }
